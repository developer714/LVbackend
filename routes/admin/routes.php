...
//Route::post('ajax-admin-login',[LoginController::class, 'ajaxLogin']);
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'products', 'as' => 'products.'], function () {
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::post('updateProductById/{id}', 'updateProductById');
    ...
    Route::group(['prefix' => 'sub-category', 'as' => 'sub-category.'], function () {
	    ...
	    Route::get("getAllSubCategories", "getAllSubCategories");
    ...
    Route::group(['prefix' => 'sub-sub-category', 'as' => 'sub-sub-category.'], function () {
	    ...
	    Route::get("getAllSubSubCategories", "getAllSubSubCategories");
