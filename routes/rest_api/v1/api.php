...
use App\Http\Controllers\RestAPI\v1\auth\MemberController;
use App\Http\Controllers\RestAPI\v1\BranchController; 
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
Route::group(['namespace' => 'RestAPI\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::put('customer/language-change', 'CustomerController@language_change');
