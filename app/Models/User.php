 ...
 * @property string $mountains_and_rivers
 * @property string $community_pv
 * @property string $circulation_rate
 * @property string $suspension_of_benefits
 * @property string $status
 * @property string $payment_and_amount
 *
 * @package App\Models
 */
class User extends Authenticatable
{
    ...
    protected $casts = [
        ...
        'concierge' => 'string',
        'suggestion' => 'string',
        'mountains_and_rivers' => 'string',
        'community_pv' => 'string',
        'circulation_rate' => 'string',
        'suspension_of_benefits' => 'string',
        'status' => 'string',
        'payment_and_amount' => 'string',
    ];
