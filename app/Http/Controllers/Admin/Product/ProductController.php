  ...
  public function getAllProducts(Request $request): JsonResponse
    {
        ...
        $sub_sub_category_id = $request->input('sub_sub_category_id');
               ...
               $filters = [
            'name' => $search ? function($query) use ($search) {
        ...
        $products = $this->productRepo->getListWhere(orderBy: ['id' => 'desc'], searchValue: $request['searchValue'], filters: [], dataLimit: getWebConfig(name: WebConfigKey::PAGINATION_LIMIT));
